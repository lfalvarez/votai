...
class ProposalSuggestionForIncremental(models.Model):
    incremental = models.ForeignKey('IncrementalsCandidateFilter', related_name="suggestions", on_delete=models.CASCADE)
    proposal = models.ForeignKey('popular_proposal.PopularProposal', related_name="suggested_proposals", on_delete=models.CASCADE)
