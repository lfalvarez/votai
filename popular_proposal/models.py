...
class ProposalTemporaryData(models.Model, ProposalCreationMixin):
    ...
    proposer = models.ForeignKey(User, related_name='temporary_proposals', on_delete=models.CASCADE)
    area = models.ForeignKey(Area, related_name='temporary_proposals', null=True, blank=True, on_delete=models.CASCADE)
...
class PopularProposalSite(models.Model):
    popular_proposal = models.ForeignKey('PopularProposal', on_delete=models.CASCADE)
...
class PopularProposal(models.Model, OGPMixin):
    ...
    proposer = models.ForeignKey(User, related_name='proposals', on_delete=models.CASCADE)
    area = models.ForeignKey(Area, related_name='proposals', null=True, blank=True, on_delete=models.CASCADE)
    join_advocacy_url = models.URLField(null=True, blank=True)
...
class ProposalLike(models.Model):
    ...
    proposal = models.ForeignKey(PopularProposal, on_delete=models.CASCADE)
