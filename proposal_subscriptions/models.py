...
class CommitmentNotification(models.Model):
    user = models.ForeignKey(User, related_name='commitment_notifications', on_delete=models.CASCADE)
    commitment = models.ForeignKey(Commitment, related_name="notifications", on_delete=models.CASCADE)
