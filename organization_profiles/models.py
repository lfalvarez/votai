...
class OrganizationTemplate(models.Model, ShareableMixin):
    organization = models.OneToOneField(User, related_name='organization_template', on_delete=models.CASCADE)
...
class ExtraPage(models.Model):
    template = models.ForeignKey(OrganizationTemplate, related_name='extra_pages', on_delete=models.CASCADE)
    content = models.TextField(default="")
    title = models.CharField(max_length=512,
