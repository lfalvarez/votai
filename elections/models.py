...
class PersonalData(models.Model):
    candidate = models.ForeignKey('Candidate', related_name="personal_datas", on_delete=models.CASCADE)
...
class QuestionCategory(Category):
    election = models.ForeignKey('Election', related_name='categories', null=True, on_delete=models.CASCADE)
...
class Election(ExtraInfoMixin, models.Model, OGPMixin):
    ...
    area = models.ForeignKey(Area, blank=True, null=True, related_name="elections", on_delete=models.CASCADE)
